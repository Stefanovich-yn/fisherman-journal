...
public class FindByWaterBodyCommand implements Command {

    private final RecordLogic recordService;

    public FindByWaterBodyCommand(RecordLogic recordService) {
    ...
    public String execute(String request) {
        try {
            ...
            String waterBoy = params.get("waterBody");

            List<CatchRecord> records = recordService.findByWaterBody(waterBoy);
            return formatResult(records);

        } catch (LogicException e) {
            return "ERROR: Missing required parameter 'waterBody'.";
        }
    }
