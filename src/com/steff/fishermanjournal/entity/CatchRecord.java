...
public class CatchRecord {
    ...
    public boolean equals(Object o) {
        ...
        return quantity == that.quantity && weight == that.weight && Objects.equals(id, that.id) && Objects.equals(fishermanName, that.fishermanName) && Objects.equals(fishType, that.fishType) && Objects.equals(waterBody, that.waterBody) && status == that.status && Objects.equals(createdAt, that.createdAt);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, fishermanName, fishType, quantity, weight, waterBody, status, createdAt);
    }
}
